...
const Footer = () => {
    return (
        <div>
            <footer className="footer flex justify-between md:px-28  p-10 bg-black text-white">
    ...
    <p>Copyright © 2024 - All right reserved by <span className='text-red-400' >Rezuan </span></p>
  </aside>
                <nav>
                    <h6 className=" text-white font-bold mb-4">Social</h6>
                    <div className="grid grid-flow-col text-slate-300 gap-4">
